		...
		} else
		{
			...
			if($QueryResult === FALSE)
			{
				...
				<script type="text/javascript">
					...
					window.location.href = "EditVolwassenen.php";
				</script>
				<?php
			} else
			{
...
<html>
	<head>
		<title>Wijzig pagina Volwassenen</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="content">
				<h2><i class="fa fa-file-o" aria-hidden="true"></i> Wijzig Pagina Workshops Volwassenen</h2>
