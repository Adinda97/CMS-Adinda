...
if(isset($_POST['update']))
{
	...
	} else
	{
		...
		} else
		{
			...
			$SQLstring = "UPDATE `$TableName` SET `kop1`='$editText1', `text1`='$editText2', `kop2`='$editText3', `text2`='$editText4' WHERE 1";
			...
			if($QueryResult === FALSE)
			{
				...
				<script type="text/javascript">
					...
					window.location.href = "EditMenuRechts.php";
				</script>
				<?php
			} else
			{
...
<html>
	<head>
		<title>Wijzig pagina Menu Rechts</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="content">
				<h2><i class="fa fa-file-o" aria-hidden="true"></i> Wijzig Pagina Workshops Menu Rechts</h2>
