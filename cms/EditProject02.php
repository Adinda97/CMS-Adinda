...
if(isset($_POST['update']))
{
	...
	} else
	{
		...
		{
			$editText5 = $_POST['kop3'];
			$editText6 = $_POST['text3'];
			$SQLstring = "UPDATE `$TableName` SET `kop3`='$editText5', `text3`='$editText6' WHERE 1";
			...
			if($QueryResult === FALSE)
			{
				...
				<script type="text/javascript">
					...
					window.location.href = "EditProject02.php";
				</script>
				<?php
			} else
			{
...
<html>
	<head>
		<title>Wijzig paginga Project 2</title>
	...
	<body>
		...
		<div id="container">
			...
			<div id="content">
				<h2><i class="fa fa-file-o" aria-hidden="true"></i> Wijzig Pagina Project 2</h2>
					<form  method="post" action="#" class="formPage">
						<h3>Titel 1</h3>
						<input type="text" name="kop3" class="editBox" value="<?php echo $value5; ?>" /><br>
						<h3>Tekst 1</h3>
						<textarea name="text3" class="editArea"><?php echo $value6; ?></textarea>
